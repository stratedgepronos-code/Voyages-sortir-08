...
// Page d'admin assurances — menu racine (valable pour tout le site : golf, circuits, autotours, séjours packagé, parcs…)
add_action('admin_menu', function() {
    add_menu_page('🛡️ Assurances voyage', '🛡️ Assurances', 'manage_options', 'vs08v-insurance', ['VS08V_Insurance', 'admin_page'], 'dashicons-shield', 25);
});
