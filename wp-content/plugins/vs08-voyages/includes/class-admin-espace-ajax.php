<?php
/**
 * AJAX espace admin front (/espace-admin/) — handlers déplacés du thème pour fiabilité (plugin toujours chargé, HPOS).
 */
...
class VS08V_Admin_Espace_Ajax {
    ...
    public static function ajax_send_reminder() {
        ...
        $titre = is_scalar($titre_raw) ? (string) $titre_raw : ($is_circuit ? 'Circuit' : 'Séjour golf');
        ...
        $headers = ['Content-Type: text/html; charset=UTF-8', 'From: Voyages Sortir 08 <' . $from_addr . '>'];
