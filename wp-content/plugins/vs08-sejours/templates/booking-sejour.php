...
@media(max-width:768px){.bks-page{padding:100px 0 40px!important}.bks-container{max-width:100%;overflow-x:hidden;padding:0 16px}.bks-route-header{padding:10px 12px;gap:6px;border-radius:10px}.bks-route-iata{font-size:18px}.bks-route-city{font-size:8px}.bks-route-arrow{font-size:14px}.bks-route-dates{font-size:9px;padding:2px 6px}.bks-combo-card{overflow:hidden}.bks-combo-leg{padding:10px 12px}.bks-combo-time{font-size:18px}.bks-section{padding:16px}}
/* Filter sidebar */
