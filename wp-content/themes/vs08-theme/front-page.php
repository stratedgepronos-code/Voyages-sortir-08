...
.dl-item{display:flex;gap:0;align-items:stretch;border-radius:14px;overflow:hidden;cursor:pointer;transition:transform .2s;margin-bottom:14px;text-decoration:none}
        ...
        <div class="dl-grid">
            <div class="dl-half dl-dark">
                ...
                <a href="<?php echo esc_url($dlg['link']); ?>" class="dl-item dl-item-dark" style="text-decoration:none">
                    ...
                    <div style="padding:10px 14px 10px 0;flex:1;display:flex;flex-direction:column">
