...
//   SERPAPI_API_KEY=xxxx   (recommandé prod : Google Flights ; config.cfg non déployé par Git)
//   Ou env VS08_SERPAPI_API_KEY / SERPAPI_API_KEY, ou define dans wp-config avant wp-settings
